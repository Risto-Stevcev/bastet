...
describe("Tuple", () => {
  ...
  describe("Apply", () => {
    ...
    property1(
      "should satisfy associative composition", arb_tuple((arb_string, arb_nat)), (n) => {
      V.associative_composition(
        (String.Monoid.empty,(++)("!")), (String.Monoid.empty, string_of_int), n
      )
    })
  });
  ...
  describe("Eq", () => {
    ...
    property1(
      "should satisfy reflexivity", arb_tuple((arb_string, arb_nat)), V.reflexivity
    );
    property2(
