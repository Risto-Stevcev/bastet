...
module ResultF = {
  module Int = {
    ...
    module Bool = {
      ...
      module Show =
        Result.Show(OcamlAbstractInt.Show, OcamlAbstractBool.Show);
    };
    module Float = {
      ...
      module Show =
        Result.Show(OcamlAbstractInt.Show, OcamlAbstractFloat.Show);
    };
    module String = {
      ...
      module Show =
        Result.Show(OcamlAbstractInt.Show, OcamlAbstractString.Show);
    };
  };
  module Float = {
    module Functor =
    ...
    module Bool = {
      ...
      module Show =
        Result.Show(OcamlAbstractFloat.Show, OcamlAbstractBool.Show);
    };
    module Int = {
      ...
      module Show =
        Result.Show(OcamlAbstractFloat.Show, OcamlAbstractInt.Show);
    };
    module String = {
      module Eq = Result.Eq(OcamlAbstractFloat.Eq, OcamlAbstractString.Eq);
      module Ord =
        Result.Ord(OcamlAbstractFloat.Ord, OcamlAbstractString.Ord);
      module Show =
        Result.Show(OcamlAbstractFloat.Show, OcamlAbstractString.Show);
    };
  };
  module Bool = {
    module Functor =
    ...
    module Int = {
      ...
      module Show =
        Result.Show(OcamlAbstractBool.Show, OcamlAbstractInt.Show);
    };
    module Float = {
      ...
      module Show =
        Result.Show(OcamlAbstractBool.Show, OcamlAbstractFloat.Show);
    };
    module String = {
      ...
      module Show =
        Result.Show(OcamlAbstractBool.Show, OcamlAbstractString.Show);
    };
  };
  module String = {
    module Functor =
    ...
    module Int = {
      ...
      module Show =
        Result.Show(OcamlAbstractString.Show, OcamlAbstractInt.Show);
    };
    module Float = {
      module Eq = Result.Eq(OcamlAbstractString.Eq, OcamlAbstractFloat.Eq);
      module Ord =
        Result.Ord(OcamlAbstractString.Ord, OcamlAbstractFloat.Ord);
      module Show =
        Result.Show(OcamlAbstractString.Show, OcamlAbstractFloat.Show);
    };
    module Bool = {
      ...
      module Show =
        Result.Show(OcamlAbstractString.Show, OcamlAbstractBool.Show);
    };
  };
};
