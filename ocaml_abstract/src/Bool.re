...
module Bounded_Lattice: BOUNDED_LATTICE with type t = bool = {
  ...
  include (
            Bounded_Meet_Semilattice: BOUNDED_MEET_SEMILATTICE with type t := t
          );
};
...
module Bounded_Distributive_Lattice:
  BOUNDED_DISTRIBUTIVE_LATTICE with type t = bool = {
...
module Involutive_Heyting_Algebra:
  INVOLUTIVE_HEYTING_ALGEBRA with type t = bool = {
